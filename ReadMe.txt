========================================================================
		ActiveX Control DLL : TEST_OCX_PARAMENT_ARRAY
========================================================================

ControlWizard has created this project for your TEST_OCX_PARAMENT_ARRAY ActiveX Control
...
test_ocx_parament_array.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
Test_ocx_parament_array control:

Test_ocx_parament_arrayCtl.h
	This file contains the declaration of the CTest_ocx_parament_arrayCtrl C++ class.

Test_ocx_parament_arrayCtl.cpp
	This file contains the implementation of the CTest_ocx_parament_arrayCtrl C++ class.

Test_ocx_parament_arrayPpg.h
	This file contains the declaration of the CTest_ocx_parament_arrayPropPage C++ class.

Test_ocx_parament_arrayPpg.cpp
	This file contains the implementation of the CTest_ocx_parament_arrayPropPage C++ class.

Test_ocx_parament_arrayCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CTest_ocx_parament_arrayCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file test_ocx_parament_array.rc.
